...
@RefreshScope
@Configuration
@MapperScan(basePackages = {"com.example.saas2.datasource"}, sqlSessionFactoryRef = "dynamicDataSourceFactory")
public class MybatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(
        ...
        bean.setMapperLocations(
                // 设置mybatis的xml所在位置
                new PathMatchingResourcePatternResolver().getResources("classpath:*db/*Mapper.xml"));
